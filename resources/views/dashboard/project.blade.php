...
@section('dash.main')
    <div class="row justify-content-end">
        <a href="{{ route('project.create') }}" role="button" class="btn btn-dark col col-auto"> <i
    ...
    <div class="my-4">
        ...
        <form action="{{ route('project.destroy') }}" method="POST">
            ...
            <div class="my-3 text-end">
                <button type="submit" class="btn btn-danger">Supprimer les projets Selectionner</button>
            </div>
            <h2 class="text-fv-primary my-2"> {{ $posts->count() }} Projets </h2>
            <ul class="list-group">
