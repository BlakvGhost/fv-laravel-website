...
@section('title')
    Voir Les Postes du Blog | Admin
@endsection
@section('dash.main')
    <div class="row justify-content-end">
        <a href="{{ route('blog.create') }}" role="button" class="btn btn-dark col col-auto"> <i
    ...
    <div class="my-4">
        ...
        <form action="{{ route('blog.destroy') }}" method="POST">
            ...
            <div class="my-3 text-end">
                <button type="submit" class="btn btn-danger">Supprimer les Blogs Selectionner</button>
            </div>
            <h2 class="text-fv-primary my-2"> {{ $posts->count() }} Blogs </h2>
            <ul class="list-group">
