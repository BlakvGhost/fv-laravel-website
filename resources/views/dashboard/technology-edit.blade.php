...
@section('dash.main')
    ...
    <form action="{{ route('technology.update') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @if( $errors->any())
        ...
        <div class="form-group my-2">
            ...
            <input type="text" name="icon" value="{{ $post->icon }}" id="title2" placeholder="Entrer la classe mdi de l'icon :"
                   class="form-control">
        </div>
        <div class="form-group my-2">
