    ...
    <div class="border-top p-3">
        <div class="container-custom my-3">
            <div class="fv-title-normal fvSlideOn my-3">
                <h3 class="text-fv-primary"><span class="dbslash">//</span> &nbsp; Blog / Categorie / <i :class="`mdi ${category.results[0].icon ? '' : ''} align-middle`"></i> {{ $route.params.title }}</h3>
            </div>      
            ...
            <div class="my-3 container-fluid">
                ...
                <div class="row fv-f-direc-col-sm">
                    <Blog v-for="post in category.results[0].blogs" :key="post.id" :current-user="{user:currentUser}" :post="post" style-custom="height:390px;" bg-style-custom="height:200px;"></Blog>
                </div>
